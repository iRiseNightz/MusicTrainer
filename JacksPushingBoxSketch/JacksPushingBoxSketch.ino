...
void loop() {
  ...
  // Make a HTTP request:  
  String APIRequest;
  //http://api.pushingbox.com/pushingbox?devid=vE4C2F236BDAD61B&Tempo=100&Outcome=fail
  APIRequest = String(serverName) + "/pushingbox?devid=" + String(devid)+ "&Tempo=100&Outcome=fail" ;
